...
double sqrt(double x)
{
    ...
    */
    ...
    //6 steps because I'm insecure of this method
    u.x = 0.5f * (u.x + x/u.x);
    u.x = 0.5f * (u.x + x/u.x);
    u.x = 0.5f * (u.x + x/u.x);
    u.x = 0.5f * (u.x + x/u.x);
...
/*
    The implementations of sin, cos, tan, exp and acos are here
...
{
    // Not very good precision
    const double a0 = 1.57079632679489661;
    const double a1 = -6.86225485913931799e-1;
    const double a2 = 1.32166590149486058e-151;
    const double a3 = -7.98481761590913950e-1;
    const double a4 = -1.22679393124305328e-151;
